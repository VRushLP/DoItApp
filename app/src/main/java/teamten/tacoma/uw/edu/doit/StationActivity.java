...
//            Log.d(TAG, "Add a new list");
            Bundle userEmailData = new Bundle();
            userEmailData.putString("EMAIL", userEmailSharePref);
            ListAddFragment listAddFragment = new ListAddFragment();
            listAddFragment.setArguments(userEmailData);
            getSupportFragmentManager().beginTransaction()
                    .replace(R.id.station_activity, listAddFragment)
                    .addToBackStack(null)
                    .commit();
            return true;
        }
...
//        ListDetailFragment courseDetailFragment = new ListDetailFragment();
//        Bundle args = new Bundle();
//        args.putSerializable(ListDetailFragment.COURSE_ITEM_SELECTED, item);
//        courseDetailFragment.setArguments(args);
//
//        getSupportFragmentManager().beginTransaction()
//                .replace(R.id.station_container, courseDetailFragment)
//                .addToBackStack(null)
//                .commit();
    }
