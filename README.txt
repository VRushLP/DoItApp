...
Uses web services to retrieve or store data for the app.
   Our app uses web services for authentication at the moment. Users registering and logging in are both checked against a database before their actions are completed.
